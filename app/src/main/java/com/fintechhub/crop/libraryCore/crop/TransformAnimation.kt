...
import com.fintechhub.crop.libraryCore.utils.lerpAngle

@Composable
fun animateImgTransform(target: ImgTransform): State<ImgTransform> {
...
fun ImgTransform.lerp(target: ImgTransform, p: Float): ImgTransform {
    if (p == 0f) return this
